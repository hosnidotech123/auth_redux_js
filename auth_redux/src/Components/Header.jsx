                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="hidden md:block">
                            <nav aria-label="Global">
                                <ul className="flex items-center gap-6 text-sm">
                                    ...
                                    <li  className={`${user.username==="admin"?"":"hidden"}`}>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="sm:flex sm:gap-4">
                                <Link
                                    className={`rounded-md ${user.username==="admin"?"hidden":""} bg-teal-600 px-5  py-2.5 text-sm font-medium text-white shadow`}
                                    to="/login"
                                >
                                    Login
                                </Link>
                                ...
                                <div className="hidden sm:flex">
                                    <Link
                                        className={`rounded-md ${user.username==="admin"?"hidden":""}  bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600`}
                                        to="/register"
                                    >
                                        Register
                                    </Link>
